...
// Setup Theme
add_action( 'after_setup_theme', 'smartcity_setup' );
function smartcity_setup(): void {
	 ...
	 */
	load_theme_textdomain( 'smartcity', get_parent_theme_file_path( '/languages' ) );
    ...
    register_nav_menus(
        array(
            'primary'   => esc_html__('Primary Menu', 'smartcity'),
        )
    );
