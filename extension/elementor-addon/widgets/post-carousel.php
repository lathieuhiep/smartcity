...
class SmartCity_Elementor_Post_Carousel extends Widget_Base {
    ...
    public function get_name(): string {
        return 'smartcity-post-carousel';
    }

    public function get_title(): string {
        return esc_html__( 'Posts Carousel', 'smartcity' );
    }
