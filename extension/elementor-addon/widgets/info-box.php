...
class SmartCity_Elementor_Info_Box extends Widget_Base {
	...
	public function get_name(): string {
		return 'smartcity-info-box';
	}

	public function get_title(): string {
		return esc_html__( 'Info box', 'smartcity' );
	}
	...
	protected function register_controls(): void {
		...
		$this->add_control(
			'img_type',
			[
				'label' => esc_html__('Infobox Type', 'smartcity'),
				'type' => Controls_Manager::SELECT,
				'default' => 'img-on-top',
				'label_block' => false,
				'options' => [
					'img-on-top' => esc_html__('Image/Icon On Top', 'smartcity'),
					'img-on-left' => esc_html__('Image/Icon On Left', 'smartcity'),
					'img-on-right' => esc_html__('Image/Icon On Right', 'smartcity'),
				],
			]
		);
		...
		$this->add_control(
			'img_or_icon',
			[
				'label' => esc_html__('Image or Icon', 'smartcity'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'none' => [
						'title' => esc_html__('None', 'smartcity'),
						'icon' => 'fa fa-ban',
					],
					...
					'img' => [
						'title' => esc_html__('Image', 'smartcity'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Icon Position', 'smartcity'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'condition' => [
					'img_type!' => 'img-on-top',
		...
		$this->add_control(
			'selected_image',
			[
				'label' => esc_html__('Infobox Image', 'smartcity'),
		...
		$this->add_control(
			'selected_icon',
			[
				'label' => esc_html__('Icon', 'smartcity'),
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__('Content', 'smartcity'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('This is an icon box', 'smartcity'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'rows' => 10,
				'default' => esc_html__('Write a short description, that will describe the title or something informational and useful.', 'smartcity'),
		...
		$this->add_control(
			'show_description',
			[
				'label' => esc_html__('Show Description', 'smartcity'),
		...
		$this->add_responsive_control(
			'content_alignment',
			[
				'label' => esc_html__('Content Alignment', 'smartcity'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => esc_html__('Icon Size', 'smartcity'),
		...
		$this->add_control(
			'icon_color',
			[
				'label' => esc_html__('Icon Color', 'smartcity'),
