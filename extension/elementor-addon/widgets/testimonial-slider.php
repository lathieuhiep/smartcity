...
class BasicTheme_Elementor_Testimonial_Slider extends Widget_Base {
    ...
    public function get_name(): string {
        return 'smartcity-testimonial-slider';
    }

    public function get_title(): string {
        return esc_html__( 'Testimonial Slider', 'smartcity' );
    }
    ...
    protected function register_controls(): void {
        ...
        $repeater->add_control(
            'list_title', [
                ...
                'default' => esc_html__( 'John Doe' , 'smartcity' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'list_position',
            [
                'label'         =>  esc_html__( 'Position', 'smartcity' ),
                'type'          =>  Controls_Manager::TEXT,
                'default'       =>  esc_html__( 'Codetic', 'smartcity' ),
                'label_block'   =>  true
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'rows' => 10,
                'default' => esc_html__( 'GEMs are robotics algorithm for modules that built & optimized for NVIDIA AGX Data should underlie every business decision. Data should underlie every business Yet too often some very down the certain routes.', 'smartcity' ),
