<?php
$opt_number_columns = smartcity_get_option('opt_footer_columns', '4');
        ...
        <div class="container">
            <div class="row">
                ...
                for( $i = 0; $i < $opt_number_columns; $i++ ):
                    $j = $i +1;
                    $smartcity_col = smartcity_get_option( 'opt_footer_column_width_' .  $j, 3);

                    if( is_active_sidebar( 'sidebar-footer-column-'.$j ) ):
                ?>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-<?php echo esc_attr( $smartcity_col ); ?>">
